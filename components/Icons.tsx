...
export const Icon = ({ name, size = 20, className = "" }: { name: string; size?: number; className?: string }) => {
  const icons: Record<string, React.ReactNode> = {
    ...
    pin: (
      <>
        <path d="M21.4 17.6L16 12.2V6a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v6.2l-5.4 5.4" />
        <path d="M1 21h22" />
      </>
    ),
    file: (
    ...
    trophy: (
      <>
        ...
        <path d="M10 14.66V17" />
        <path d="M14 14.66V17" />
        <path d="M18 2h-6c-1.66 0-3 1.34-3 3v4.66c0 1.66 1.34 3 3 3h6c1.66 0 3-1.34 3-3V5c0-1.66-1.34-3-3-3z" />
      </>
    ),
    medal: (
      <>
